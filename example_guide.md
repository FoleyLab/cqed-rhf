...
- **Nitrobenzene (unsubstituted):** [`examples/nitrobenzene/NITRO/nitrobenzene_field_scan.py`](https://github.com/FoleyLab/cqed-rhf/blob/main/examples/nitrobenzene/META/meta_field_scan.py)
